...
export function AuditFilters({ value, onChange }: AuditFiltersProps) {
  ...
  const hasActiveFilters = internal.action || internal.client_id || internal.account_id || internal.from_date || internal.to_date;
    ...
    <div className="space-y-4 p-6 bg-white rounded-lg border border-slate-200 shadow-sm">
      <div className="flex items-center justify-between pb-2 border-b border-slate-100">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-base text-slate-900">Filtrar Auditoría</h3>
        </div>
        {hasActiveFilters && (
      ...
      <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <div className="space-y-2">
          <Label htmlFor="audit-action" className="text-sm font-medium text-slate-700 flex items-center gap-2">
        ...
        {/* Client ID Filter */}
        <div className="space-y-2">
          <Label htmlFor="audit-client-id" className="text-sm font-medium text-slate-700 flex items-center gap-2">
          ...
          <div className="relative">
            <Input
              ...
              onChange={(e) => setInternal((prev) => ({ ...prev, client_id: e.target.value }))}
        ...
        {/* Account ID Filter */}
        <div className="space-y-2">
          <Label htmlFor="audit-account-id" className="text-sm font-medium text-slate-700 flex items-center gap-2">
          ...
          <div className="relative">
            <Input
              ...
              onChange={(e) => setInternal((prev) => ({ ...prev, account_id: e.target.value }))}
      ...
      <div className="pt-2">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            <Label htmlFor="audit-start-date" className="text-xs text-slate-600">
              Fecha Inicio
            </Label>
            <Input
              id="audit-start-date"
              ...
              onChange={(e) => setInternal((prev) => ({ ...prev, from_date: e.target.value }))}
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) => setInternal((prev) => ({ ...prev, to_date: e.target.value }))}
